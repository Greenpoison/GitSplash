...
mod build_bundled {
    ...
    pub fn main(out_dir: &str, out_path: &Path) {
        ...
        // GitSplash patch: `cfg_select!` is still gated behind an unstable
        // std feature on current stable rustc (no version has it usable
        // without a `#![feature(cfg_select)]` this crate never declares) —
        // rewritten as the equivalent, stable `#[cfg(...)]` block pair.
...
mod bindings {
    ...
    pub fn sqlite3_cancel_auto_extension(
        ...
        // GitSplash patch: see the matching note above.
        #[cfg(feature = "loadable_extension")]
        {
