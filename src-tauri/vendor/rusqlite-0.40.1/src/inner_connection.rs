...
impl InnerConnection {
    ...
    pub fn prepare<'a>(
        ...
        // GitSplash patch: see the note on `error_with_offset` in error.rs.
    ...
    pub fn changes(&self) -> u64 {
        unsafe {
            ...
            let n = ffi::sqlite3_changes64(self.db()) as u64; // 3.37.0
            #[cfg(not(feature = "modern_sqlite"))]
            let n = ffi::sqlite3_changes(self.db()) as u64;
            n
        }
    }
    ...
    pub fn total_changes(&self) -> u64 {
        unsafe {
            #[cfg(feature = "modern_sqlite")]
            let n = ffi::sqlite3_total_changes64(self.db()) as u64; // 3.37.0
            #[cfg(not(feature = "modern_sqlite"))]
            let n = ffi::sqlite3_total_changes(self.db()) as u64;
            n
        }
    }
